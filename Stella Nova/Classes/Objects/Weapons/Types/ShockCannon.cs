...
namespace Stella_Nova.Classes.Objects.Weapons.Types
{
    public class ShockCannon : Weapon
    {
        ...
        public ShockCannon(List<Vector2> barrels)
            : base(barrels)
        {
            Barrels = barrels;
            MagazineSize = 64;
        ...
        public ShockCannon(List<Vector2> barrels, int magazineSize)
        ...
        public ShockCannon(List<Vector2> barrels, int magazineSize, int loaded)
        ...
        public ShockCannon(List<Vector2> barrels, int magazineSize, int loaded, int ammunition)
        ...
        public ShockCannon(List<Vector2> barrels, int magazineSize, int loaded, int ammunition, int projectileCount)
        ...
        public ShockCannon(List<Vector2> barrels, int magazineSize, int loaded, int ammunition, int projectileCount, int barrelIndex)
        ...
        public ShockCannon(List<Vector2> barrels, int magazineSize, int loaded, int ammunition, int projectileCount, int barrelIndex, float fireRate)
        ...
        public ShockCannon(List<Vector2> barrels, int magazineSize, int loaded, int ammunition, int projectileCount, int barrelIndex, float fireRate, float spread)
        ...
        public ShockCannon(List<Vector2> barrels, int magazineSize, int loaded, int ammunition, int projectileCount, int barrelIndex, float fireRate, float spread, float velocity)
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                ParticleManager.particles.Add(
                    new Spark(
                        ...
                        Color.FromNonPremultiplied(91, 91, 91, 255), Color.Aquamarine, Color.FromNonPremultiplied(66, 66, 66, 255)));
            }
        }
        public override void CreateNewProjectile(Vector2 pos, Vector2 vel, float angle, int teamIndex)
        {
            Projectile temp = new Laser(pos.X, pos.Y, vel.X, vel.Y, 0f, 0f, angle, 0f, 0f, 1f, 0.8f, teamIndex, 1, 5, 14, 0.23f, 1.4f, 0.15f + ((float)Main.random.NextDouble() * Spread), 24, 12, 0.001f, Color.White, Color.MediumSpringGreen);
