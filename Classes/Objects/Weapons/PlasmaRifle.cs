    ...
    public class PlasmaRifle : Weapon
    {
        ...
        public override void CreateMuzzleFlash(Vector2 pos, Vector2 vel, float angle, int teamIndex)
        {
            ...
            new Blur(
                ...
                (float)Main.random.NextDouble() - 0.5f,
                0f, 0.1f, 0.7f, (float)Main.random.NextDouble() + 0.2f, teamIndex,
        ...
        {
            Projectile temp = new Bullet(pos.X, pos.Y, vel.X, vel.Y, 0f, 0f, angle, 0f, 0f, 1f, 0.8f, teamIndex, 3, 5, 14, 0.23f, 1.9f, 3f);
