...
namespace Stella_Nova.Classes.Objects.Projectiles
{
    public class Shrapnel : Projectile
    {
        ...
        public Shrapnel(Projectile projectile)
            : base(projectile)
        {
        ...
        {
            if (Utility.CalculateChancePerSecond(delta, 24f * (1f - TimeAlive / MaxLifespan)))
            {
                for (int i = 0; i < 3; i++)
                {
                    ParticleManager.particles.Add(
                        new Spark(
                            ...
                            (float)Main.random.NextDouble() - 0.5f,
                            0f, 0.1f, 0.1f,
                            0.2f + (float)Main.random.NextDouble() / 5f, TeamIndex, 16,
                    ...
                    ParticleManager.particles.Add(
                        new Smoke(
                            ...
                            (float)Main.random.NextDouble() - 0.5f,
                            0f, 0.1f, 0.1f,
                            0.8f + (float)Main.random.NextDouble() / 2f, TeamIndex, 24,
